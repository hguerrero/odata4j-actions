...
public class EntityRequestResource extends BaseResource {
  ...
  public Response deleteEntity(@Context HttpHeaders httpHeaders, @Context UriInfo uriInfo,
    ...
    if (producer.getMetadata().containsEdmFunctionImport(entitySetName)) {
      ...
      return FunctionResource.callFunction(ODataHttpMethod.DELETE, httpHeaders, uriInfo, securityContext, producer, entitySetName, format, callback, null, null);
    }
  ...
  @Produces({ ODataConstants.APPLICATION_ATOM_XML_CHARSET_UTF8,
          ODataConstants.TEXT_JAVASCRIPT_CHARSET_UTF8, ODataConstants.APPLICATION_JAVASCRIPT_CHARSET_UTF8 })
