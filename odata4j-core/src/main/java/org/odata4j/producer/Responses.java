...
public class Responses {
  ...
  public static SimpleResponse simple(final EdmSimpleType<?> type, final String name, final Object value) {
    ...
    /**
     * Creates a new <code>InfinispanResponse</code> instance for JSON string payloads as a jsonValue field.
     *
     * @param type EdmSimpleType.STRING is expected
     * @param name jsonValue is expected as this will be returned to the client in http response
     * @param value json entity represented as string
     * @param status status for HTTP response
     * @return a new <code>InfinispanResponse</code> instance
     */
    public static InfinispanResponse infinispanResponse(final EdmSimpleType<?> type, final String name, final Object value,
                                                        final Response.Status status) {
        return new InfinispanResponse() {
